...
// {
//   public:
//     Airports source; /**< The source of the edge **/
//     Airports dest; /**< The destination of the edge **/
...
//      * @param lbl - the edge label
//      */
//     Edge(Airports u, Airports v, string lbl)
//         : source(u), dest(v), label(lbl), weight(-1)
//     { /* nothing */
//     }
...
//      * @param lbl - the edge label
//      */
//     Edge(Airports u, Airports v, double w, string lbl)
//         : source(u), dest(v), label(lbl), weight(w)
//     { /* nothing */
//     }

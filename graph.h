...
//      * @return a vector of vertices
//      */
//     vector<Airports> getAdjacent(Airports source) const;
...
//      * @return a vertex from the graph
//      */
//     Airports getStartingVertex() const;

//     /**
//      * Gets all vertices in the graph.
//      * @return a vector of all vertices in the graph
//      */
//     vector<Airports> getVertices() const;
...
//      *         - if edge doesn't exist, return Edge()
//      */
//     Edge getEdge(Airports source, Airports destination) const;
...
//      *         - if Vertex doesn't exist, return false
//      */
//     bool vertexExists (Airports v) const;
...
//      *         - if Edge doesn't exist, return false
//      */
//     bool edgeExists(Airports source, Airports destination) const;
...
//      *         - if edge doesn't exist, return InvalidEdge
//      */
//         Edge setEdgeLabel(Airports source, Airports destination, string label);
...
//      *         - if edge doesn't exist, return InvalidLabel
//      */
//     string getEdgeLabel(Airports source, Airports destination) const;
...
//      *         - if doesn't, return InvalidWeight
//      */
//     int getEdgeWeight(Airports source, Airports destination) const;

//     /**
//      * Inserts a new vertex into the graph and initializes its label as "".
//      * @param v - the name for the vertex
//      */
//     void insertVertex(Airports v);
...
//      *         - if not, return InvalidVertex;
//      */
//     Vertex removeVertex(Airports v);
...
//      * @return whether inserting the edge was successful
//      */
//     bool insertEdge(Airports source, Airports destination);
...
//      *         - if not, return InvalidEdge
//      */
//     Edge removeEdge(Airports source, Airports destination);
...
//      *         - if not, return InvalidEdge
//      */
//     Edge setEdgeWeight(Airports source, Airports destination, int weight);
...
// private:
//     mutable unordered_map<Airports, unordered_map<Airports, Edge>> adjacency_list;
...
//      *  in the event of an error
//      */
//     bool assertVertexExists(Airports v, string functionName) const;
...
//      *  in the event of an error
//      */
//     bool assertEdgeExists(Airports source, Airports destination, string functionName) const;

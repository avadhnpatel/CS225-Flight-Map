...
// const Airports Graph::InvalidVertex = "INVALIDVERTEX";
// const int Graph::InvalidWeight = INT_MIN;
...
// vector<Airports> Graph::getAdjacent(Airports source) const 
// {
//     auto lookup = adjacency_list.find(source);
...
//     else
//     {
//         vector<Airports> vertex_list;
//         unordered_map <Airports, Edge> & map = adjacency_list[source];
//         for (auto it = map.begin(); it != map.end(); it++)
//         {
//             vertex_list.push_back(it->first);
//         }
...
// Airports Graph::getStartingVertex() const
// {
//     return adjacency_list.begin()->first;
// }

// vector<Airports> Graph::getVertices() const
// {
//     vector<Airports> ret;
...
// Edge Graph::getEdge(Airports source , Airports destination) const
// {
//     if(assertEdgeExists(source, destination, __func__) == false)
//         return Edge();
//     Edge ret = adjacency_list[source][destination];
...
//     vector<Edge> ret;
//     set<pair<Airports, Airports>> seen;

//     for (auto it = adjacency_list.begin(); it != adjacency_list.end(); it++)
//     {
//         Airports source = it->first;
//         for (auto its = adjacency_list[source].begin(); its != adjacency_list[source].end(); its++)
//         {
//             Airports destination = its->first;
//             if(seen.find(make_pair(source, destination)) == seen.end())
//             {
//                 //this pair is never added to seen
//                 ret.push_back(its->second);
...
// bool Graph::vertexExists(Airports v) const
// {
//     return assertVertexExists(v, "");
// }

// bool Graph::edgeExists(Airports source, Airports destination) const
// {
//     return assertEdgeExists(source, destination, "");
// }

// Edge Graph::setEdgeLabel(Airports source, Airports destination, string label)
// {
//     if (assertEdgeExists(source, destination, __func__) == false)
//         return InvalidEdge;
//     Edge e = adjacency_list[source][destination];
...
// string Graph::getEdgeLabel(Airports source, Airports destination) const
// {
//     if(assertEdgeExists(source, destination, __func__) == false)
//         return InvalidLabel;
//     return adjacency_list[source][destination].getLabel();
...
// int Graph::getEdgeWeight(Airports source, Airports destination) const
// {
//     if (!weighted)
//         error("can't get edge weights on non-weighted graphs!");
...
// void Graph::insertVertex(Airports v)
// {
//     // will overwrite if old stuff was there
//     removeVertex(v);
//     // make it empty again
//     adjacency_list[v] = unordered_map<Airports, Edge>();
// }


// Vertex Graph::removeVertex(Airports v)
// {
...
// bool Graph::insertEdge(Airports source, Airports destination)
// {
//     if(adjacency_list.find(source)!= adjacency_list.end() 
//     && adjacency_list[source].find(destination)!= adjacency_list[source].end())
//     {
...
//     if(adjacency_list.find(source)==adjacency_list.end())
//     {
//         adjacency_list[source] = unordered_map<Airports, Edge>();
//     }
//         //source vertex exists
//     adjacency_list[source][destination] = Edge(source, destination);
//     if(adjacency_list.find(destination)== adjacency_list.end())
//     {
//         adjacency_list[destination] = unordered_map<Airports, Edge>();
//     }
//     if(!directed)
//     {
//         adjacency_list[destination][source] = Edge(source, destination);
...
// Edge Graph::removeEdge(Airports source, Airports destination)
// {
//     if(assertEdgeExists(source, destination, __func__) == false)
//         return InvalidEdge;
//     Edge e = adjacency_list[source][destination];
...
// Edge Graph::setEdgeWeight(Airports source, Airports destination, int weight)
// {
//     if (assertEdgeExists(source, destination, __func__) == false)
//         return InvalidEdge;
//     Edge e = adjacency_list[source][destination];
...
// bool Graph::assertVertexExists(Airports v, string functionName) const
// {
//     if (adjacency_list.find(v) == adjacency_list.end())
//     {
//         if (functionName != "")
...
// bool Graph::assertEdgeExists(Airports source, Airports destination, string functionName) const
// {
//     if(assertVertexExists(source,functionName) == false)
//         return false;
//     if(adjacency_list[source].find(destination)== adjacency_list[source].end())
